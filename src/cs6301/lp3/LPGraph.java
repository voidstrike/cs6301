...
public class LPGraph extends Graph{
    ...
    public static void main(String[] args)
        ...
        BasicGraphAlgorithm helper = new BasicGraphAlgorithm(lg);

        List<Vertex> travel =helper.dfs(src);

        helper.assignSCC(lg.iterator());
        for(Graph.Vertex u : lg){
            System.out.println(u.toString() + "  SCC:" + helper.node[u.getName()].sccNum);
        }
