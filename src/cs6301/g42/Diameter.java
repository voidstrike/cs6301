...
public class Diameter {
    ...
    public static LinkedList<Graph.Vertex> diameter(Graph g) {
        ...
        Graph.Vertex root = g.getVertex(1); // select a random node A to run BFS, here just pick index 1
        queue.add(root);
    ...
    public static void main(String[] args) {
    	...
    	LinkedList<Graph.Vertex> result = diameter(Graph.readGraph(in, directed));
